...
def test_savings_sources_use_direct_official_campaign_urls():
    items = sources("Türkiye Finans Birikim / Fon Kampanyaları")
    urls = {item["url"] for item in items}

    assert urls == {
        "https://www.turkiyefinans.com.tr/tr-tr/kampanyalar/Sayfalar/gunluk-hesap-vade-kampanyasi.aspx",
        "https://www.turkiyefinans.com.tr/tr-tr/kampanyalar/Sayfalar/katilim-hesabi-kampanyasi.aspx",
    }
...
def test_all_three_sources_exist_in_campaign_pages():
    ...
    assert (
        ...
        "kampanyalar/Sayfalar/gunluk-hesap-vade-kampanyasi.aspx"
    ) in pages
    assert (
        "https://www.turkiyefinans.com.tr/tr-tr/"
        "kampanyalar/Sayfalar/katilim-hesabi-kampanyasi.aspx"
    ) in pages


def test_turkiye_finans_has_current_twelve_sources():
    bank = turkiye_finans()
