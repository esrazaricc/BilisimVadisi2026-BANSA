...
def build_steps(
    ...
    # DİKKAT:
    # classify_campaign_records.py bilinçli olarak bu listede yoktur.
    # Mevcut sınıflandırıcı bütün eski kayıtları yeniden sınıflandırdığı
    # için doğrulanmış Kuveyt Türk dağılımını bozabiliyor.
    return [
        PipelineStep(
...
def main() -> int:
    ...
    if args.dry_run:
        ...
        print("  - Finansman kampanyası: 9")
        print("  - Finansman manuel kontrol: 0")
        print("  - Finansman dışı kampanya: 101")
        print("  - Yüksek öncelikli kontrol: 0")
        print("  - Orta öncelikli kontrol: 0")
        print("  - Temiz görünen: 101")
    print("=" * 80)
    return 0
