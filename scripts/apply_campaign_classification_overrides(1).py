...
def print_summary(
    ...
    # Bazı eski / henüz sınıflandırılmamış kayıtlarda
    # record_kind veya campaign_category NULL olabilir.
    # Raporlama katmanı bu nedenle None ile str değerlerini
    # doğrudan sıralamamalıdır.
    kind_counts = Counter(
