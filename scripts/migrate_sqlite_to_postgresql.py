    ...
    try:
        ...
        product_table_specs = [
            ...
            ("live_product_pricing_tiers", "product_pricing_tiers",
             ["id","product_id","financing_amount","maturity_months","profit_share_rate","allocation_fee_rate","monthly_total_cost_rate","annual_total_cost_rate","source_text","updated_at","pricing_variant","value_type","source_type","conditions","source_url"]),
            ("live_finance_fact_evidence", "finance_fact_evidence",
             ["id","product_id","fact_key","value_text","value_numeric","value_type","source_type","conditions","source_url","source_text","verification_status","updated_at"]),
